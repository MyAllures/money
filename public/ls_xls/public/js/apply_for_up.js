...
//				是否可以申请
				if(data.apply_status != "2"){
					...
					for(var i in data1){
						...
						html += '<p class="upg3t1s">当前等级:<span class="level_name_1">'+data1[i].level_name_now+'</span></p>';
...
//						html += '<span class="level_name" style="display: inline-block;">'+data1[i].level_name+'</span></p>';
						...
						if(is_apply == 0){
							...
							html += '<div><div class="upg3t3" style="margin-top:0.45rem;"><div class="upg3t3le">';
							...
							if(data1[i].apply_info.up_user.head_icon == ""){
								...
								html += '<img src="'+data1[i].apply_info.up_user.head_icon+'" alt=""/></p></div>';
							}
							...
							html += '</p></div>';
							if(is_apply == "1"){
								html += '<div class="upg3t3le" style="background:transparent;"><p class="upg3t3lep" style="text-align: center;"><a href="fukuan_info.html?user_id='+data1[i].apply_info.up_user.user_id+'">去打款</a></p></div></div></div>';
							}else{
